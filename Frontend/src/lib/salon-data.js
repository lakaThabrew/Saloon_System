...
export const SERVICES = [
  {
    ...
    targetGender: "UNISEX",
    durationMinutes: 45,
    description: "Consultation, precision cut & styling to finish.",
    isActive: true,
    imageUrl: haircutImg,
  },
  {
    id: 2,
    serviceName: "Classic Beard Trim",
    category: "BEARD",
    targetGender: "MALE",
    durationMinutes: 30,
    description: "Line-up, shape & hot towel finish.",
    isActive: true,
    imageUrl: beardImg,
  },
  {
    ...
    targetGender: "UNISEX",
    durationMinutes: 90,
    description: "Single-process colour with a glossing treatment.",
    isActive: true,
    imageUrl: colorImg,
  },
  {
    ...
    targetGender: "FEMALE",
    durationMinutes: 150,
    description: "Hand-painted lived-in highlights.",
    isActive: true,
    imageUrl: colorImg,
  },
  {
    id: 5,
    serviceName: "Scalp & Hair Spa",
    category: "SPA",
    targetGender: "UNISEX",
    durationMinutes: 60,
    description: "Deep-conditioning ritual with a scalp massage.",
    isActive: true,
    imageUrl: spaImg,
  },
  {
    ...
    targetGender: "UNISEX",
    durationMinutes: 45,
    description: "Shape, cuticle care & long-wear gel polish.",
    isActive: true,
    imageUrl: nailsImg,
  },
  {
    ...
    targetGender: "FEMALE",
    durationMinutes: 120,
    description: "Full glam with a trial session included.",
    isActive: true,
    imageUrl: makeupImg,
  },
  {
    ...
    targetGender: "UNISEX",
    durationMinutes: 30,
    description: "Gentle cut for the little ones.",
    isActive: true,
    imageUrl: kidsImg,
  },
  {
    ...
    targetGender: "FEMALE",
    durationMinutes: 45,
    description: "Bouncy, camera-ready blowout for any occasion.",
    isActive: true,
    imageUrl: blowoutImg,
  },
];
...
export const STAFF = [
  {
    id: 101,
    fullName: "Ava Laurent",
    email: "ava@maisonblade.co",
    phone: "555-0101",
    gender: "FEMALE",
    specialization: "Cutting & Colour",
    experienceYears: 12,
    serviceIds: [1, 3, 4, 9],
  },
  {
    ...
    email: "marcus@maisonblade.co",
    phone: "555-0102",
    gender: "MALE",
    specialization: "Barbering",
    experienceYears: 8,
    serviceIds: [1, 2, 8],
  },
  {
    id: 103,
    fullName: "Priya Shah",
    email: "priya@maisonblade.co",
    phone: "555-0103",
    gender: "FEMALE",
    specialization: "Colour Correction",
    experienceYears: 10,
    serviceIds: [1, 3, 4],
  },
  {
    id: 104,
    fullName: "Noa Kimura",
    email: "noa@maisonblade.co",
    phone: "555-0104",
    gender: "FEMALE",
    specialization: "Spa · Nails · Makeup",
    experienceYears: 6,
    serviceIds: [5, 6, 7],
  },
];
...
export function generateSlotsFor(staffId, date) {
